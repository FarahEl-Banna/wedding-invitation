...
const ThemeToggle = () => {
  ...
  const initialDarkTheme = localStorage.theme === "dark"|| (!("theme" in localStorage) && systemPrefersDark);
  ...
  return (
    <div className="inline-block justify-center items-center dark:bg-gray-800 rounded-md">
